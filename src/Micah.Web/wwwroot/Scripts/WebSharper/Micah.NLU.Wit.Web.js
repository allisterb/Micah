...
{
 "use strict";
 var Global,WebSharper,Obj,Micah,NLU,Wit,ConverseResponse,Entity,Intent,Meaning,Trait,WitApiResponse,WitApi,IntelliFactory,Runtime,$;
 Global=self;
 WebSharper=Global.WebSharper;
 Obj=WebSharper&&WebSharper.Obj;
 Micah=Global.Micah=Global.Micah||{};
 NLU=Micah.NLU=Micah.NLU||{};
 Wit=NLU.Wit=NLU.Wit||{};
